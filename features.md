...
<div class="feature-grid">
  ...
  <article class="feature-card">
    <h3>并发更新与卸载</h3>
    <p>支持多个工具同时更新，每个工具卡片独立展示进度；也可通过 brew、npm、winget、scoop 卸载已识别工具。</p>
  </article>
</div>
...
<div class="feature-grid">
  <article class="feature-card">
    <h3>启动检查更新</h3>
    <p>应用首次打开时自动检查 GitHub Releases，新版本可用时弹窗提示，由用户决定是否下载安装。</p>
  </article>
  <article class="feature-card">
    <h3>一键分享</h3>
    <p>设置页可复制 GitHub 仓库地址，方便把 AI Toolkit 推荐给其他开发者或团队成员。</p>
  </article>
</div>
